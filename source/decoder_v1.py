...
class LDPCBPDecoder1(Layer):
    ...
    def __init__(self,
        ...
        self._llr_max_minsum = 1000     # changed by R. Wiesmayr to a larger value
    ...
    def _cn_update_minsum(self, msg):
        ...
        LARGE_VAL = 100000. # pylint: disable=invalid-name  # changed by R. Wiesmayr to a higher value
...
class LDPC5GDecoder1(LDPCBPDecoder1):
    ...
    def __init__(self,
        ...
        # changed by R. Wiesmayr to a larger value
        # (10x larger than message clipping value in order to avoid overruling punctured LLRs)
